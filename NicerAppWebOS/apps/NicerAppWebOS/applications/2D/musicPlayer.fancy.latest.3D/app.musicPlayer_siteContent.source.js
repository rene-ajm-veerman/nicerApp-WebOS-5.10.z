        ...
        loadedIn : {
            '#siteContent' : {
                onload : function (settings) {
                    debugger;
                    na.site.settings.current.app = '/NicerAppWebOS/apps/NicerAppWebOS/applications/2D/musicPlayer.javascriptRendering';
		...
		if (!na.mp.settings.afterInitializing) {
            ...
            na.m.waitForCondition (
                ...
                function () {
                    ...
                    $('.vividButton, .vividButton4, .vividButton_icon_50x50, .vividButton_icon_100x100', $('#siteContent')).each(function(idx,el) {
                        $(el).css({width:w});
...
//}, 100); // na.m.waitForCondition() (see top of this file)
                ...
                na.m.waitForCondition ('DOM ready', function() {
                    debugger;
                    return na && na.apps && typeof na.musicPlayer =='object' /*&& $.ui && $.ui.draggable*/ && $('#mp3s')[0] && $('#app__musicPlayer__player')[0];
                }, function() {
