...
?>
<div id="btnOptions_menu__background" class="vividDialogPopup_background" style="position:absolute;width:calc(100%);height:calc(100%);z-index:-1;left:0px;top:0px; padding:0;margin:0;"></div>
...
<div id="btnOptions_menu__backgroundTimeSettingsChanged_save__containerDiv">
    ...
    <div style="margin:10px;width:calc(100% - 40px)">
        <span>Min</span><input id="delayNewItemsMin" type="number" min="0" max="2000" value="200" style="width:100px;height:1em;margin-left:15px" onchange="var na1 = na.apps.loaded['/NicerAppWebOS/apps/NicerAppWebOS/applications/2D/news'], g = na1.globals, s = na1.settings, c = s.current, db = c.db; na1.settingsChanged(event);"></input><br/><br/>
