...
?>
<div id="btnOptions_menu__background" style="background:rgba(0,50,0,0.555);position:absolute;width:calc(100%);height:calc(100%);z-index:-1;left:0px;top:0px; padding:0;margin:0;"></div>
