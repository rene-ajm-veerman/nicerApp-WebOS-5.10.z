nicerapp.photoAlbum = na.pa = {
	...
	printAlbum_handleFileLoad : function (event) {
		...
		div.children('a').attr('href', na.m.globals.urls.app + 'photo/' + event.item.id.replace(na.m.globals.urls.app+'siteData/NicerAppWebOS/com/ui/photoAlbum/albums/','').replace('/lowres','').replace(/\//g,'_') + '--' + s.page);
