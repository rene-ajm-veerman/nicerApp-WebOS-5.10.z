...
$photoAlbums_globals = array (
	'pathAlbums' => SA_SITE_HD.'siteData/NicerAppWebOS/com/ui/photoAlbum/albums/',
	'urlAlbums' => SA_SITE_WEB.'siteData/NicerAppWebOS/com/ui/photoAlbum/albums/',
...
function photoAlbum_updateAlbumsFolders ($albumsContents) {
	...
	$bgs = getFilePathList (SA_SITE_HD.'siteData/NicerAppWebOS/com/ui/photoAlbum/albums', true, '/(.*)/', array('file'));
	$bgs2 = array();
...
function photoAlbum_html_menu () {
	...
	global $naWebOS;
	$rootPath = $photoAlbums_globals['pathAlbums'];
	$albumsNestedList = $naWebOS->dbMain->get ('nicerapp/com/ui/photoAlbum/albumsNestedList', true);
...
function photoAlbum_html_viewAlbumContent ($album) {
	...
	$albumRelativePath = photoAlbum_urlDecode ($album);
	$albumsContents = $naWebOS->dbMain->get ('nicerapp/com/ui/photoAlbum/albumsContents', true);
