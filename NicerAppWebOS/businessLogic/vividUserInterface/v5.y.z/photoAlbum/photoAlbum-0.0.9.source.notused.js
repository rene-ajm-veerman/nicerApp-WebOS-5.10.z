	...
	checkPageImagesLoaded_preloadAll : function (settings) {
		...
		if (
			...
			html +=
				'<tr style="height:*"><td>&nbsp;</td></tr>'
				+'</table>'
				+'<a id="btnPagePrevious" href="#" style="position:absolute;top:50%;z-index:10000;width:40px;"><img src="'+na.m.globals.urls.app+'/NicerAppWebOS/com/ui/photoAlbum/btnPrevious.png" style="width:40px;"/></a>'
				+'<a id="btnPageNext" href="#" style="position:absolute;top:50%;right:0px;z-index:10000;width:40px;"><img src="'+na.m.globals.urls.app+'/NicerAppWebOS/com/ui/photoAlbum/btnNext.png" style="width:40px;"/></a>';
