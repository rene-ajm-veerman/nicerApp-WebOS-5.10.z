...
na.ui.vividButton = na.ui.vb = {
    ...
    init : async function (buttonHTMLid) {
        ...
        if (na.ui.vb.settings.buttons['#'+buttonHTMLid]) return false;
        na.ui.vb.settings.buttons['#'+buttonHTMLid] = {
            el : el,
            type : buttonType,
            btnCode : btnCode,
            circumstance : 'normal',
            to : { circumstance : null }
        };
        ...
        el.addEventListener ('mouseenter', function(evt) {
            na.ui.vb.hoverOver (b,evt);
        });
        el.addEventListener ('mouseleave', function(evt) {
            na.ui.vb.hoverOut (b,evt);
        });
    ...
    hoverOver : function (b,evt) {
        if (b.to.circumstance=='hover') return false;
        //console.log ('hoverOver', evt.currentTarget, console.trace());
        //debugger;
    ...
    hoverOut : function (b,evt) {
        if (b.to.circumstance=='normal') return false;
        //console.log ('hoverOut', evt.currentTarget, console.trace());
        //debugger;
    ...
    anim_increaseGradient : function (b, l, ato) {
        ...
        if (l.animDirection!=='increase') return false;
        ato.step++;
        b.circumstance = b.to.circumstance;
        if (ato.step < ato.animSteps)
            setTimeout (function () {
            ...
            //debugger;
            //var x = b.circumstance;
            //b.circumstance = b.to.circumstance;
            //b.to.circumstance = null;
        }
    },
    
    anim_decreaseGradient : function (b, l, ato) {
        if (typeof ato.step=='undefined') ato.step = -1;
        if (l.animDirection!=='decrease') return false;
        ato.step++;
        b.circumstance = b.to.circumstance;
        if (ato.step < ato.animSteps)
            setTimeout (function () {
