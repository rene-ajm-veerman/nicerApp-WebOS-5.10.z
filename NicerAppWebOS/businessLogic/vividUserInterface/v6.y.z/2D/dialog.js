        ...
        if (idx!==false && na.site.globals.themesDBkeys[idx].display) {
            ...
            html += (
                    ...
                    ? '<div class="vdSettings" style="z-index:10000;opacity:'+opacity+';position:absolute;top:-10px;left:10px;z-index:7000000">'
                            +'<img class="btnSettings" style="width:50px;" src="/NicerAppWebOS/siteMedia/btnPickColor.png" onclick="na.d.s.visibleDivs = arrayRemove (na.d.s.visibleDivs,\'#siteToolbarThemeEditor\');na.d.s.visibleDivs.push (\'#siteToolbarThemeEditor\'); na.desktop.resize(); na.site.settings.activeDivs = [\'#siteToolbarThemeEditor\']; var d = na.site.c.dialogs[\'#'+this.el.id+'\']; d.displaySettingsDialog(d, \''+t.el.id+'\')"/>'
                ...
                +(
                    ...
                    ? '<div class="vdTools" style="z-index:10000;opacity:'+opacity+';position:absolute;right:10px;top:-10px;z-index:7000000">'
                        +'<img class="btnComments" style="width:50px;" src="/NicerAppWebOS/siteMedia/pencil.png" onclick="if (na.d.s.visibleDivs.includes(\'siteComments\')) arrayRemove(na.d.s.visibleDivs,\'#siteComments\'); else na.d.s.visibleDivs.push(\'#siteComments\'); na.desktop.resize();"></div>'
                    : ''
                );
            if (
