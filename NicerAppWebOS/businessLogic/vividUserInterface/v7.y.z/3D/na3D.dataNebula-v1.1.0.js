...
//if (it.name.match(/becoming insane/i)) debugger;
            //if (it.model) {
                ...
                if (it && it.parent && prevIt && prevIt.parent && it.parent.idx!==prevIt.parent.idx) {
                    px = p.sPos.x
                        + (p.columnOffsetValue*msx*c2.c.x)
                    py = p.sPos.y
                        + (p.rowOffsetValue*msy*c2.c.y)
                    pz = p.sPos.z
                        + (p.depth*msz*c2.c.y)
                }
                prevIt = it;
